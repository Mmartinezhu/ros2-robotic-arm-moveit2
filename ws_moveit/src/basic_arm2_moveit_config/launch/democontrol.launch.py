...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("basic_arm2", package_name="basic_arm2_moveit_config")
        .robot_description(file_path="config/basic_arm2.urdf.xacro")
        .robot_description_semantic(file_path="config/basic_arm2.srdf")
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("basic_arm2_moveit_config"),
        "config",
